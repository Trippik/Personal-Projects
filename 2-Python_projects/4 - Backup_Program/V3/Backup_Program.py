...
backup_directory = "\\\BABBAGE\Backup\\"
...
def record_run_time():
    print("Recording date and time of backup in root backup directory: ")
    print(backup_directory)
    os.system("copy /y NUL " + backup_directory + "Backup Last Run " + str(datetime.datetime.now()) + ".txt >NUL")
